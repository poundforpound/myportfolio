    ...
    return (
        <StyledProject>
            ...
            <ProjectInfo>
                ...
                <ButtonContainer>
                    <ProjectButton iconId={"linkChain"} text={"Live Preview"} widthIcon={"15"} heightIcon={"15"} viewBox={"0 0 20 20"}/>
                    <ProjectButton iconId={"githubFill"} text={"View Code"} widthIcon={"15"} heightIcon={"15"} viewBox={"0 0 85 85"}/>
                </ButtonContainer>
            </ProjectInfo>
        </StyledProject>
    );
